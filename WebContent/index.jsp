    ...
    <header> 
      ...
      <div class="logo"> 
        ...
        <h2> 
          ...
          <img width="100" height="55" alt="Logo do Seringa" src="seringalogo.png" />  
      ...
      <div class="menu"> 
        ...
        <ul> 
          ...
          <li><a href="index.html">Sobre o Seringa</a></li> 
...
<input class="btn" type="submit" value="Logar" id="submit"></div> 
...
<head> 
    ...
    <!-- <style>
      ...
      .filho{ 
        ...
        align-items: center; 
        flex-direction: column; 
        box-shadow: 0px 1px 4px 0px #A65355; 
      } 
      input{ 
        padding: 8px 30px; 
...
<div> 
<label for="submit"></label> 
<input class="btn" type="submit" value="Logar" id="submit">
</div> 
</body> 
</html> 